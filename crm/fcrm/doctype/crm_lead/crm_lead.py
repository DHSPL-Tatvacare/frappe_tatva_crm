...
class CRMLead(Document):
	...
	def default_list_data():
		columns = [
			...
			{"label": "Product Line", "type": "Link", "key": "custom_vertical", "options": "CRM Vertical", "width": "10rem"},
			{"label": "Group", "type": "Link", "key": "custom_group", "options": "CRM Group", "width": "9rem"},
			{"label": "Program", "type": "Link", "key": "custom_current_program", "options": "CRM Program", "width": "10rem"},
			...
			{"label": "Status", "type": "Link", "key": "status", "options": "CRM Lead Status", "width": "9rem"},
			{"label": "Stage", "type": "Link", "key": "custom_stage", "options": "CRM Lead Stage", "width": "9rem"},
			{"label": "Sub-stage", "type": "Link", "key": "custom_substage", "options": "CRM Lead Stage", "width": "9rem"},
			...
			{"label": "Last Activity", "type": "Datetime", "key": "custom_prospectactivitydate_max", "width": "9rem"},
		...
		rows = [
			"name", "mobile_no", "lead_name", "custom_vertical", "custom_group",
			"custom_current_program", "creation", "modified", "_assign", "lead_owner",
			"status", "custom_stage", "custom_substage", "custom_lead_temperature", "source",
			"custom_source_origin", "email", "custom_city", "custom_state", "gender",
			"custom_patient_id", "custom_prospectactivitydate_max", "custom_last_report_date",
			"custom_order_value", "sla_status", "first_name", "image",
		]
