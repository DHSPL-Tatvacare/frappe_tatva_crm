...
class CRMDeal(Document):
	...
	def default_list_data():
		columns = [
			...
			{"label": "Status", "type": "Link", "key": "status", "options": "CRM Deal Status", "width": "10rem"},
			{"label": "Deal Owner", "type": "Link", "key": "deal_owner", "options": "User", "width": "10rem"},
			{"label": "Deal Value", "type": "Currency", "key": "deal_value", "align": "right", "width": "9rem"},
			{"label": "Expected Value", "type": "Currency", "key": "expected_deal_value", "align": "right", "width": "9rem"},
		...
		rows = [
			"name", "lead", "lead_name", "organization", "status", "deal_owner", "deal_value",
			"expected_deal_value", "expected_closure_date", "probability", "source", "mobile_no",
			"email", "creation", "modified", "currency", "_assign",
		]
