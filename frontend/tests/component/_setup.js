...
// Unmount every mounted component after its test so its own teardown runs (timers, watchers, listeners);
// without this a component outlives its test and its scheduled work fires into a dead environment.
