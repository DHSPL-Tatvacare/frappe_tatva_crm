...
| `frontend/src/tatva/TatvaBottomSheet.vue` | NEW (`// TATVA:` `@headlessui/vue` Dialog + slide-up `TransitionChild`, safe-area aware) | The additive mobile bottom-sheet primitive (CRM has none); the MobileSidebar stack, sliding from the bottom |
